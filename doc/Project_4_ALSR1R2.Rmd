---
title: "Project 4 ALS R1R2"
author: "HANG HU hh2718"
date: "11/20/2019"
...
```{r}
source("../lib/cross_validation_R1R2.R")
f_list <- seq(10, 20, 10)
l_list <- seq(1, 2, 1)
...
save(result_summary, file = "../output/rmser1r2new.Rdata")
```

```{r}
load("../output/rmser1r2new.Rdata")
...
save(result, file = "../output/mat_fac_r1r2new.RData")
```
